...
/**
 * Created by Sedat Er on 8.01.2018.
 */
...
public class OfferCar {
    ...
    public OfferCar(String offerFiyat, String offerModel, String offerSehir, String offerAciklama, String offerDate, String offerUserId) {
